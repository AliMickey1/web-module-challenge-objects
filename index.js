...
function getReviewByIndex(array, numInd) {
  return `${array[numInd].name} gave the restaurant a ${array[numInd].rating} star review, and their feedback was: ${array[numInd].feedback}`;
}
